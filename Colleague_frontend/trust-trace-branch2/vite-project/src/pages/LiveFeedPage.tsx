      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-white/60">
            Real-time KOL calls tracked across crypto Twitter
          </p>
        </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1">
                      ...
                      {kol.verified && (
                        <div className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center shadow-lg shadow-purple-500/50">
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                      ...
                      <span className="text-xs text-white/40">
                        ${call.priceAtCall.toLocaleString()}
                      </span>
                      {call.currentPrice && (
                        <span className={`text-xs font-medium ${
                          call.currentPrice > call.priceAtCall ? 'text-green-400' : 'text-red-400'
                        }`}>
                          {call.currentPrice > call.priceAtCall ? '+' : ''}
                          {((call.currentPrice - call.priceAtCall) / call.priceAtCall * 100).toFixed(1)}%
                        </span>
                      )}
                    </div>
                  </div>
